                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    ...
                                                    <label for="inputPasswordConfirm">Şifreyi Onayla</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mt-4 mb-0">
                                            <div class="d-grid"><a class="btn btn-primary btn-block"
                                                    href="<?php echo base_url(); ?>">Oluştur</a></div>
                                        </div>
                                    </form>
                                </div>
                                <div class="card-footer text-center py-3">
                                    <div class="small">Bir hesabınız var mı? <a
                                            href="<?php echo base_url(); ?>login">Giriş yapın</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
